 ...
 * @section DESCRIPTION
 *
 * The EndRoundDialog class represents the dialog when end of the round.
 */
...
public:
     ...
     * @param winnerScores The winner's scores.
     */
    EndRoundDialog( QWidget* parent = 0, QString winnerName = "", int winnerScores = 0 );
